...
module.exports = class ObservedFilesList {
  constructor(mainModule) {
    ...
    this.selectList = lumine.workspace.buildSelectList({
      ...
      confirmAction: "typst-tools:open-selected-file",
      additionalActionCommands: ["typst-tools:clear-all-observed-files"],
      actionsFilter: (descriptor) =>
        descriptor.name !== "typst-tools:clear-all-observed-files" || this.items.length > 0,
