module.exports = class ObservedFilesStatusView {
  constructor(callbacks = {}) {
    ...
    this.element.classList.add("typst-tools-observed-status");
    ...
    this.tooltip = lumine.tooltips.addComposite(this.element, [
      {
        ...
        keyBindingExtra: "LMB",
        keyBindingCommand: "typst-tools:observed-files",
      },
      {
        title: "Clear all observed files",
        keyBindingExtra: "RMB",
        keyBindingCommand: "typst-tools:clear-all-observed-files",
      },
    ]);
